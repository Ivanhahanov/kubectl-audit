...
| `kubectl audit triage` | Interactive TUI to review `findings.json`, record triage decisions, and export or push confirmed findings to Jira — see [Triage](https://ivanhahanov.github.io/kubectl-audit/triage/). |
